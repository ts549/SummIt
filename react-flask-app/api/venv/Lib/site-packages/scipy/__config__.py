...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.13.1",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-ea20vqrz\overlay\Lib\site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-j__66jzb\cp310-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.10",
        },
    }
)
